export class UIManager {
    ...
    showRecordingComplete(frameCount, duration) {
        const durationSeconds = Math.round(duration / 1000 * 100) / 100;
        this.updateStatus(`Recording complete: ${frameCount} frames, ${durationSeconds}s`, 'success');
    }
    showSaving() {
    ...
    drawPoseLandmarks(landmarks, canvasWidth, canvasHeight) {
        const ctx = this.getCanvasContext();
    ...
    drawPoseConnections(ctx, landmarks, canvasWidth, canvasHeight) {
