export class AvatarRenderer {
    ...
    async playAnimation(landmarksData, onProgress) {
    ...
    landmarkToVector3(landmark) {
        ...
        return new window.THREE.Vector3(landmark.x - 0.5, -landmark.y + 0.5, landmark.z);
    }
    stopAnimation() {
        if (this.animationId) {
        ...
        this.bones.forEach(bone => {
            ...
            if (bone.material) {
                if (Array.isArray(bone.material)) {
                    bone.material.forEach((material) => material.dispose());
                }
                else {
        ...
        this.joints.forEach(joint => {
            ...
            if (joint.material) {
                if (Array.isArray(joint.material)) {
                    joint.material.forEach((material) => material.dispose());
                }
                else {
    ...
    enableCameraControls() {
        ...
        if (window.THREE.OrbitControls && this.camera && this.renderer) {
...
//# sourceMappingURL=avatar-renderer.js.map